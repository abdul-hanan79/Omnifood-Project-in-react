        ...
        <div className="container grid grid--footer">
          <div className="logo-col">
            ...
            <ul className="social-links">
              <li>
                <a className="footer-link" href="#"> <ion-icon class="social-icon" name="logo-instagram" /></a>
              </li>
              <li>
                <a className="footer-link" href="#"> <ion-icon class="social-icon" name="logo-facebook" /></a>
              </li>
              <li>
                <a className="footer-link" href="#"> <ion-icon class="social-icon" name="logo-twitter" /></a>
              </li>
            </ul>
            <p className="copyright">
              Copyright © <span className="year">2027</span> by Omnifood, Inc.
              All rights reserved.
            </p>
          </div>
